...
getWordsFromElement(){let elFirstContent=this.el.innerHTML.trim();let allElemnts=Array.from(elFirstContent.split(/[–, -]/g));this.messages=allElemnts.map(string=>string.trim());console.log(this.messages);this.el.innerHTML=''}
